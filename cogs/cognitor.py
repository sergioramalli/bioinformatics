...
class cogs(object):
	...
	def _queryDb(self):
		...
		os.system("makeblastdb -in " + self.query['sequences'] + " -dbtype prot -out " + self.query['db'] );
	...
	def _runCognitor(self):
		...
		os.system("COG_software/COGmakehash/COGmakehash -i=" + self.directory + "tmp.p2o.csv -o=" + self.directory + "BLASTcogn -s=',' -n=1" );
		os.system("COG_software/COGreadblast/COGreadblast -d=" + self.directory + "BLASTcogn -u=" + self.directory + "BLASTno -f=" + self.directory + "BLASTff -s=" + self.directory + "BLASTss -e=0.1 -q=2 -t=2" );
		os.system("COG_software/COGcognitor/COGcognitor -i=" + self.directory + "BLASTcogn -t=" + self.cogs['csv'] + " -q=" + self.query['csv'] + " -o=" + self.results  );
...
cogs.setDirectory('../results/cogs/1/');
cogs._createDirectory();
cogs.setQuery("../results/NP_414543_1/psi_results.faa");
